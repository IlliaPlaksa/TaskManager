...
StepId Read::Command(const ConsoleManipulator &console)
{
...
std::string Read::Title(const ConsoleManipulator &console)
{
...
TaskId Read::Id(const ConsoleManipulator &console)
{
...
time_t Read::Date(const ConsoleManipulator &console)
{
...
Task::Priority Read::Priority(const ConsoleManipulator &console)
{
...
std::string Read::Label(const ConsoleManipulator &console)
{
...
bool Read::Confirm(const ConsoleManipulator &console)
{
