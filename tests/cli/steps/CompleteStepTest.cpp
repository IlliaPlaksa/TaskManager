...
class CompleteStepTest : public ::testing::Test
{
protected:
...
TEST_F(CompleteStepTest, shouldReturnCommand)
{
    auto complete_step = CompleteStep(dependency_);
    ...
    auto result = complete_step.Execute(context);
